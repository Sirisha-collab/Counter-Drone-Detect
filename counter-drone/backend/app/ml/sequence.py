SEQ_LEN = 20  # reports per window; at a 2 s tick that is 40 seconds of history
...
# Fixed normalisation constants, applied identically at train and inference
# time. Hard-coding them means there is no scaler file to lose or mismatch.
